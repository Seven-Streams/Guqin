...
public class guqinLexer extends Lexer {
	...
	public static final int
		ID=1, VOID=2, BOOL=3, INT=4, STRING=5, NEW=6, CLASS=7, NULL=8, TRUE=9, 
		FALSE=10, THIS=11, IF=12, ELSE=13, FOR=14, WHILE=15, BREAK=16, CONTINUE=17, 
		RETURN=18, LINE_COMMENT=19, BLOCK_COMMENT=20, WS=21, INT_VALUE=22, STRING_VALUE=23;
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"ID", "VOID", "BOOL", "INT", "STRING", "NEW", "CLASS", "NULL", "TRUE", 
			"FALSE", "THIS", "IF", "ELSE", "FOR", "WHILE", "BREAK", "CONTINUE", "RETURN", 
			"LINE_COMMENT", "BLOCK_COMMENT", "WS", "INT_VALUE", "STRING_VALUE"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			null, "ID", "VOID", "BOOL", "INT", "STRING", "NEW", "CLASS", "NULL", 
			"TRUE", "FALSE", "THIS", "IF", "ELSE", "FOR", "WHILE", "BREAK", "CONTINUE", 
			"RETURN", "LINE_COMMENT", "BLOCK_COMMENT", "WS", "INT_VALUE", "STRING_VALUE"
		};
	}
