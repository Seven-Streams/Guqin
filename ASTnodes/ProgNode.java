...
public class ProgNode extends ASTNode {
  ...
  public Mypair check() throws Exception {
    ...
    HashMap<String, Mypair> string_return = new HashMap<>();
    Mypair parseint = new Mypair("int", 0);
    Mypair length = new Mypair("int", 0);
    Mypair subs = new Mypair("string", 0);
    Mypair ord = new Mypair("int", 0);
    string_return.put("parseInt", parseint);
    string_return.put("length", length);
    string_return.put("substring", subs);
    string_return.put("ord", ord);
    class_func_return.put("string", string_return);
    HashMap<String, ArrayList<Mypair>> string_type = new HashMap<>();
    ArrayList<Mypair> args_null = new ArrayList<>();
    string_type.put("parseInt", args_null);
    string_type.put("length", args_null);
    ArrayList<Mypair> args1 = new ArrayList<>();
    args1.add(new Mypair("int", 0));
    string_type.put("ord", args1);
    ArrayList<Mypair> args2 = new ArrayList<>();
    args2.add(new Mypair("int", 0));
    args2.add(new Mypair("int", 0));
    string_type.put("substring", args2);
    class_func_args.put("string", string_type);
